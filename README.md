...
My focus is not just writing code, but solving clear tasks like:
- building user interfaces that are simple and usable
- connecting frontend with backend APIs
- understanding how data flows through an application
- improving structure instead of just adding features

---

## 🚀 Working on
- small fullstack JavaScript apps (frontend + API)
- learning how real web applications are built step by step
